...
[Source](https://atlas.zensus2011.de/)
...
Source: [Eric Fischer](https://www.flickr.com/photos/walkingsf/sets/72157624209158632/)
...
- Source: [Platform Linked Data Nederland](http://www.pilod.nl/w/images/6/62/D9-fig4.jpg)
...
Source: [LOLDAMN](http://loldamn.com/little-misunderstanding.html)
...
## Why use R - [Quicklist of useful packages](https://support.rstudio.com/hc/en-us/articles/201057987-Quick-list-of-useful-R-packages)

- To load data - [foreign](https://cran.r-project.org/web/packages/foreign/index.html), [xlsx](https://cran.r-project.org/web/packages/xlsx/vignettes/xlsx.pdf), [RPostgresSQL](https://cran.r-project.org/web/packages/RPostgreSQL/index.html)

- To manipulate data - [dplyr](https://cran.r-project.org/web/packages/dplyr/vignettes/data_frames.html), [tidyr](https://cran.r-project.org/web/packages/tidyr/vignettes/tidy-data.html)

- To visualize data - [ggplot2](docs.ggplot2.org/current/), [lattice](https://cran.r-project.org/web/packages/lattice/index.html), [DiagrammR](http://rich-iannone.github.io/DiagrammeR/)

- To model data - [lme4](http://www.rdocumentation.org/packages/lme4/functions/lme4-package), [survival](http://www.rdocumentation.org/packages/survival)

- To report results - [rmarkdown](https://rmarkdown.rstudio.com/), [shiny](https://shiny.rstudio.com), [xtable](http://www.rdocumentation.org/packages/xtable/functions/xtable)

- For Spatial data - [maptools](https://cran.r-project.org/web/packages/maptools/vignettes/combine_maptools.pdf), [sp](https://cran.rstudio.com/web/packages/sp/vignettes/csdacm.pdf), [ggmap](http://journal.r-project.org/archive/2013-1/kahle-wickham.pdf)

- For Time Series and Financial data - [zoo](https://cran.rstudio.com/web/packages/zoo/vignettes/zoo-design.pdf), [xts](https://cran.rstudio.com/web/packages/xts/)

- To write high performance R code - [rcpp](http://dirk.eddelbuettel.com/code/rcpp.html), [data.table](http://www.rdocumentation.org/packages/data.table)

- To work with the web - [XML](http://www.omegahat.org/RSXML/shortIntro.pdf), [jsonlite](https://cran.rstudio.com/web/packages/jsonlite/)

- To write your own R packages - [devtools](https://www.rstudio.com/products/rpackages/devtools/), [roxygen](http://www.rdocumentation.org/packages/roxygen2)
...
```{r,echo=F}
  link1 <- paste(graph.path,"GraphGallery.png",sep="")
```

![pic](`r link1 `)

- Source: [R-bloggers](http://www.r-bloggers.com/the-r-graph-gallery-goes-social/)
...
## R task view - [spatial statistics](https://cran.r-project.org/web/views/Spatial.html)


```{r,echo=F}
  link1 <- paste(graph.path,"TaskViewSpatial.PNG",sep="")
```
...
```{r,echo=F}
  link1 <- paste(graph.path,"cover2.jpg",sep="")
```
...
Source: [edureka!](http://www.edureka.co/blog/why-learn-r/)

## Further reading

- [Big data in the cloud](http://www.ibm.com/developerworks/library/bd-bigdatacloud/index.html)

- [Do I need to learn R?](http://www.ibm.com/developerworks/library/bd-learnr/)
...
- Klick at files with extension .md, to see the information in the browser
...
```{r,echo=F}
b <- paste("![pic](",github.path,"GithubDownload.bmp)",sep="")
```
...
```{r,echo=F}
b <- paste("![pic](",github.path,"Contact.PNG)",sep="")
```
...
```{r,echo=F}
b <- paste("![pic](",github.path,"Attention.jpg)",sep="")
```

`r b `

Source: [fotolia](https://de.fotolia.com/id/52212043)
