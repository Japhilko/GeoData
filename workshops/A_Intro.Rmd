...
- Fra Mauro map is the greatest memorial of medieval cartography

```{r,echo=F}
ab <- paste(graph.path,"FraMauroDetailedMap.jpeg.jpg",sep="")
```
...
a <- "<a href=\"http://spatial.ly/2015/07/15minutemap/\" target=\"_blank\"><img src=\"http://spatial.ly/wp-content/uploads/2015/07/hurricanes.jpg\" width=\"240\" height=\"180\" border=\"10\" /></a>
  ...
  a <- paste(graph.path,"D9-fig4.jpg",sep="")
}
```
...
Source: [Fast company](http://images.fastcompany.com/upload/4621770959_383261aebe_b.jpg)
