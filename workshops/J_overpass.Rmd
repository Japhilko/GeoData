...
The following url can be used to get a csv:

<http://overpass-api.de/api/interpreter?data=[out:csv(::"type",::"id")];area[name="Feudenheim"];node(area)[amenity=restaurant];out;>
